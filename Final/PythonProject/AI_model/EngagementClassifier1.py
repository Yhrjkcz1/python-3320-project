...
class EngagementClassifier1:
    ...
    def preprocess_data(self):
        ...
        self.train_df.fillna(self.train_df[self.numerical_cols].mean(), inplace=True)
        self.train_df.fillna(self.train_df[self.categorical_cols].mode().iloc[0], inplace=True)
